//
//  CapsuleBkWithIconExample.swift
//  MRSegmentView
//
//  Created by Mahesh Rathod on 28/03/21.
//  Copyright © 2021 MR SQUARE. All rights reserved.
//

import SwiftUI

struct CapsuleBkWithIconExample: View {
        ...
        VStack{
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(alignment: .center, spacing: 0) {
                    TabStyles(tabStyle: .capsuleBackgroundWithIcon, onSelect: {
...
struct CapsuleBkWithIconExample_Previews: PreviewProvider {
    static var previews: some View {
        CapsuleBkWithIconExample()
    }
}
